      ...
      <section className="space-y-10">
        <div className="space-y-4">
          ...
          <p className="text-base leading-7 text-slate-700">
            ...
            by Legacy Life Agency, you indicate that you agree to the collection and
            use of your information by Legacy Life Agency as outlined in this Privacy
            Policy.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-base leading-7 text-slate-700">
            First and foremost, Legacy Life Agency collects information to
        ...
        <div className="space-y-4">
          ...
          <p className="text-base leading-7 text-slate-700">
            Unless you voluntarily provide personal information for a specific
        ...
        <div className="space-y-4">
          <h3>Other Information We Collect And Use</h3>
          <p className="text-base leading-7 text-slate-700">
            We may collect online identifiers with cookies, such as IP address,
        ...
        <div className="space-y-4">
          ...
          <p className="text-base leading-7 text-slate-700">
            Some of our websites provide links to third party websites, such as
        ...
        <div className="space-y-4">
          ...
          <p>
            Legacy Life Agency stores all data using industry standard security
        ...
        <div className="space-y-4">
          <h3>How Long We Will Keep Your Personal Information</h3>
          <p className="text-base leading-7 text-slate-700">
            We retain personal information that you provide us as long as we
        ...
        <div className="space-y-4">
          ...
          <p className="text-base leading-7 text-slate-700">
            Our Privacy Policy may change from time to time. If we decide to
            change our privacy policy, we will post these changes to this
            privacy statement on surewealthsolutions.com and other places we
        ...
        <div className="space-y-4">
          ...
          <p className="text-base leading-7 text-slate-700">
            This Privacy Policy is effective and was last updated on February 5,
            2026.
          </p>
        </div>
      </section>
